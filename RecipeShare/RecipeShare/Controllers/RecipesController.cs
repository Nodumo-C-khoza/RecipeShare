...
namespace RecipeShare.Controllers
{
    ...
    public class RecipesController : ControllerBase
    {
        ...
        [HttpGet]
        [ResponseCache(Duration = 30, Location = ResponseCacheLocation.Any)] // Reduced to 30 seconds
        ...
        [HttpPut("{id}")]
        [ResponseCache(NoStore = true)] // This will prevent caching of the response
